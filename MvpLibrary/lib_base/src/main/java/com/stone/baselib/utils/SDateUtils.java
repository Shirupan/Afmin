...
public class SDateUtils {
    ...
    private static SimpleDateFormat h = new SimpleDateFormat("HH", Locale.getDefault());
    ...
    public static String getH(long timeInMills) {
        return h.format(new java.util.Date(timeInMills));
    }
