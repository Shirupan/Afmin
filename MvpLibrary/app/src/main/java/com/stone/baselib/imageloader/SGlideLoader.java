...
public class SGlideLoader implements SImgLoadible {
    ...
    @Override
    public void loadNet(Context context, String url, Options options, final SImgLoadCallback callback) {
        if (options == null) options = Options.defaultOptions();
        RequestOptions requestOptions = wrapScaleType(options);
    ...
    private RequestOptions wrapScaleType(Options options) {
        ...
        if (options != null){
            if (options.scaleType != null) {
                if (options.loadingResId != SConfig.RES_NONE) {
                    request.placeholder(options.loadingResId);
                }
                if (options.loadErrorResId != SConfig.RES_NONE) {
