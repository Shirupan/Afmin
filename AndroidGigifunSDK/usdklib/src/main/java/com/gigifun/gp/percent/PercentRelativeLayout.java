...
package com.gigifun.gp.percent;
...
public class PercentRelativeLayout extends RelativeLayout {
    private final com.gigifun.gp.percent.PercentLayoutHelper mHelper = new com.gigifun.gp.percent.PercentLayoutHelper(this);
    ...
    public static class LayoutParams extends RelativeLayout.LayoutParams
            implements com.gigifun.gp.percent.PercentLayoutHelper.PercentLayoutParams {
        private com.gigifun.gp.percent.PercentLayoutHelper.PercentLayoutInfo mPercentLayoutInfo;

        public LayoutParams(Context c, AttributeSet attrs) {
            super(c, attrs);
            mPercentLayoutInfo = com.gigifun.gp.percent.PercentLayoutHelper.getPercentLayoutInfo(c, attrs);
        }
        ...
        @Override
        public com.gigifun.gp.percent.PercentLayoutHelper.PercentLayoutInfo getPercentLayoutInfo() {
            return mPercentLayoutInfo;
        }

        @Override
        protected void setBaseAttributes(TypedArray a, int widthAttr, int heightAttr) {
            com.gigifun.gp.percent.PercentLayoutHelper.fetchWidthAndHeight(this, a, widthAttr, heightAttr);
        }
    }
}
